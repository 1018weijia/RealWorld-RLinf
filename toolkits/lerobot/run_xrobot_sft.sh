#!/usr/bin/env bash
# Usage: bash toolkits/lerobot/run_xrobot_sft.sh <config_name> <physical_gpu_id>
# Example: bash toolkits/lerobot/run_xrobot_sft.sh xrobot_sft_openpi_rlinf_pi05_put_ring_on_the_rod 7
#
# GPU selection uses COBOT_GPU_ID -> cluster.component_placement in YAML
# (same env key as cobot/dobot launchers for placement consistency).
